...
/**
 * pel_custom_fd_putchar - it writes the character c to the given file descriptor
...
/**
 * pel_custom_error_puts_fd - it prints an input string to the given file descriptor.
