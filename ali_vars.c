...
/**
 * pel_custom_is_chain - test if current char in buffer is a chain delimiter
...
/**
 * pel_custom_check_cmd_chain - checks if we should continue chaining based on last status
 * @format: the parameter struct
 * @buffer: the char buffer
 * @p: address of current position in buf
...
/**
 * pel_cutom_replace_alias - replaces an alias in the tokenized string
 * @format: the parameter struct
 *
