#include "shell.h"
/**
* pel_custom_list_length - it determines length of linked list
...
/**
* pel_custom_print_list - it only prints the text element
...
/**
* pel_custom_node_starts_with - rit returns the node whose
...
*/
CustomList_t *pel_custom_node_starts_with(CustomList_t *node,
		char *ptr, char ch)
{
char *p = NULL;
while (node)
